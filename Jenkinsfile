  ...
  stages {
    ...
    stage('Setup Python') {
      ...
      steps {
        ...
        sh 'mkdir -p workspace/.cache/pip' // Create a writable cache directory within workspace
        sh 'python -m pip install --cache-dir=workspace/.cache/pip -r requirements.txt' // Install dependencies with cache directory
      }
    }

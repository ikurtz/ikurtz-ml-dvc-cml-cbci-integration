  ...
  stages {
    ...
    stage('Setup Python') {
      ...
      steps {
        ...
        sh "kubectl exec -ti -n cloudbees-sda ${agentPodName} -- sudo chown -R 1000:1000 /home/jenkins/.pip"
        sh "kubectl exec -ti -n cloudbees-sda ${agentPodName} -- sudo chmod -R 755 /home/jenkins/.pip/cache"
